...
let URL = SERVER_URL + SERVER_API_VERSION + 'universities/'; //get current vice chancellor of the university (universities/{universityId}/currentViceChancellor)
...
const getCurrentViceChancellor = async (universityId, queryParams = null) => {
    URL = URL + universityId + '/currentViceChancellor';
