...
const SideDrawer = ({ drawerOpen, drawerCloseHandler, drawerWidthInput }) => {
  ...
  const logo =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8G70_aXsPvet0K-TvhODLgf6P8eJVQ2iL_ZsmDx5Lm9eK7C_9pWXAg3dfmtaTjad0xZM&usqp=CAU";
