    ...
    public function standard_4_6_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.6,
                'criteria_id' => 4,
                'description' => 'PGPMU has a mechanism
    ...
    public function standard_4_7_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.7,
                'criteria_id' => 4,
                'description' => ' PGPMU ensures that only
    ...
    public function standard_4_8_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.8,
                'criteria_id' => 4,
                'description' => ' The PGPMU ensures that
    ...
    public function standard_4_10_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.10,
                'criteria_id' => 4,
                'description' => 'The supervisor supports
    ...
    public function standard_4_12_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.12,
                'criteria_id' => 4,
                'description' => 'PGPMU uses occasions
    ...
    public function standard_4_13_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.13,
                'criteria_id' => 4,
                'description' => 'PGPP has mechanisms to
    ...
    public function standard_4_14_b(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 4.14,
                'criteria_id' => 4,
                'description' => 'PGPP has clear policies
    ...
    public function standard5_1(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.1,
                'criteria_id' => 5,
                'description' => 'PGPP has an approved
    ...
    public function standard5_2(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.2,
                'criteria_id' => 5,
                'description' => 'The assessment strategies
    ...
    public function standard5_3(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.3,
                'criteria_id' => 5,
                'description' => 'The PGPP monitors, reviews
    ...
    public function standard5_4(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.4,
                'criteria_id' => 5,
                'description' => 'The PGPMU has mechanisms
    ...
    public function standard5_5(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.5,
                'criteria_id' => 5,
                'description' => 'The PGPP has approved
    ...
    public function standard5_6(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.6,
                'criteria_id' => 5,
                'description' => 'The PGPMU publishes and
    ...
    public function standard5_7(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.7,
                'criteria_id' => 5,
                'description' => 'The PGPMU adheres to
    ...
    public function standard5_9(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.9,
                'criteria_id' => 5,
                'description' => 'The PGPP ensures that all
    ...
    public function standard5_11(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.11,
                'criteria_id' => 5,
                'description' => 'The PGPP has regulations
    ...
    public function standard5_12(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.12,
                'criteria_id' => 5,
                'description' => 'The PGPP maintains a
    ...
    public function standard5_14(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.14,
                'criteria_id' => 5,
                'description' => 'The services of the
    ...
    public function standard5_16(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.16,
                'criteria_id' => 5,
                'description' => 'The PGPMU and PGPP use
    ...
    public function standard5_17(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.17,
                'criteria_id' => 5,
                'description' => 'The HEI establishes a
    ...
    public function standard5_18(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 5.18,
                'criteria_id' => 5,
                'description' => 'The PGPMU ensures that the
    ...
    public function standard6_1(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                ...
                'criteria_id' => 6,
                'description' => 'The PGPP has a clearly
                stated policy and a clear plan
    ...
    public function standard6_2(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.2,
                'criteria_id' => 6,
                'description' => ' The PGPMU uses a variety
                of tools for internal evaluation
                of its programmes of study
                including the process of
                delivery and the achievement
                of specified programme
                learning outcomes.',
                'valid_slqf_levels' => json_encode([
                    'all' //all slqf levels
                ])
    ...
    public function standard6_3(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.3,
                'criteria_id' => 6,
                'description' => 'The PGPMU uses the
                ...
                and development, teaching-learning and research activities
                and assessment.',
                'valid_slqf_levels' => json_encode([
                    'all' //all slqf levels
                ])
    ...
    public function standard6_4(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.4,
                'criteria_id' => 6,
                'description' => 'The PGPP maintains up-to-date data on applicants,
    ...
    public function standard6_5(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.5,
                'criteria_id' => 6,
                'description' => 'The PGPMU periodically
                evaluates the records
                maintained by the PGPP on its
                students and graduates to
                identify completion rates, time
                to graduation, and graduate
                destinations and takes
    ...
    public function standard6_7(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.7,
                'criteria_id' => 6,
                'description' => 'The PGPMU maintains
                records of outputs resulting
                from graduate work carried out
                by registered students,
                periodically evaluates them and
                takes appropriate remedial
    ...
    public function standard6_8(): Factory{
        return $this->state(function (array $attributes) {
            return [
                ...
                'criteria_id' => 6,
                'description' => 'The PGPP or PGPMU
                encourages securing of
                research grants or other means
                of external funding to support
                student research and maintains
                up-to-date records of the
                number and value of research
                funding secured',
                'valid_slqf_levels' => json_encode([
                    '10', '11', '12'
                ])
    ...
    public function standard6_9(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.9,
                'criteria_id' => 6,
                'description' => 'The PGPP has mechanisms
    ...
    public function standard6_10(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.10,
                'criteria_id' => 6,
                'description' => 'The PGPMU regularly
                obtains feedback from external
                examiners regarding the
                examination process, and
                analyses it to identify
                perceived gaps and deficiencies
    ...
    public function standard6_11(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.11,
                'criteria_id' => 6,
                'description' => 'PGPMU makes decisions
    ...
    public function standard6_12(): Factory {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 6.12,
                'criteria_id' => 6,
                'description' => 'The PGPP ensures that the
    ...
    public function standard7_1(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.1,
                'criteria_id' => 7,
                'description' => 'PGPP has established a
    ...
    public function standard7_4(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.4,
                'criteria_id' => 7,
                'description' => 'PGPMU integrates multiple
    ...
    public function standard7_6(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.6,
                'criteria_id' => 7,
                'description' => 'The PGPP has a student
    ...
    public function standard7_7(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.7,
                'criteria_id' => 7,
                'description' => ' PGPP and PGPMU facilitate
    ...
    public function standard7_9(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                ...
                reward excellence in teaching-learning and mentoring/
                supervision.',
                'valid_slqf_levels' => json_encode([
                    'all' //all slqf levels
                ])
    ...
    public function standard7_13(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.13,
                'criteria_id' => 7,
                'description' => 'The PGPP encourages
    ...
    public function standard7_15(): Factory
    {
        return $this->state(function (array $attributes) {
            return [
                'standard_no' => 7.15,
                'criteria_id' => 7,
                'description' => 'PGPP and PGPMU offer
