...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('universities', function (Blueprint $table) {
            ...
            $table->json('fax_no');
            $table->unsignedBigInteger('vice_chancellor_id')->nullable();
            $table->unsignedBigInteger('center_for_quality_assurance_id')->nullable(); // the foreign key of the center of quality assurance
