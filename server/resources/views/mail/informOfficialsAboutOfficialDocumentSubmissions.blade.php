@component('mail::message')
    ...
    @if ($type == 'FINAL')
        We are pleased to inform you that the submission of the final report has been completed.<br>
    @elseif ($type == 'PRELIMINARY')
        We are pleased to inform you that the submission of the preliminary report has been completed.<br>
