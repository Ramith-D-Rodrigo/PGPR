...
class PostGraduateProgramReviewApplicationPolicy
{
     ...
     */
    public function view(User $user, PostGraduateProgramReviewApplication $postGraduateProgramReviewApplication): bool
    {
        //
    }
     ...
     */
    public function update(User $user, PostGraduateProgramReviewApplication $postGraduateProgramReviewApplication): bool
    {
        //
    }
